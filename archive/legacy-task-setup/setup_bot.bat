...
schtasks /Create /TN "BOGA_AI_DailyBot" /TR "C:\Users\afksm\finma\venv313\Scripts\python.exe C:\Users\afksm\finma\run_all_bots.py" /SC DAILY /ST 09:00 /F /RL HIGHEST
