...
- **Phase 2-5 — not started**: option Greeks/premium-curve panel (opsiyon242 → Supabase bridge), Reversal Score / Seller Exhaustion heuristics, calibration, dedicated Karar Sayfası tab.
...
- [ ] opsiyon242.py's SPY output reaches Supabase and is documented in `docs/DATA_CONTRACTS.md`
