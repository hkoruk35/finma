...
- **Phase 4 — not started**: logistic-regression calibration of Tier 3 scores into real probabilities. Blocked on accumulating live decision-page snapshots (no logging pipeline exists yet — needs to be built before Phase 4 can start).
...
- [ ] Decision-page snapshots are logged from first ship for future calibration — **not yet done**, blocks Phase 4
