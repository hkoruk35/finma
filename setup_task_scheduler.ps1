...
$Trigger   = New-ScheduledTaskTrigger -Weekly -DaysOfWeek Monday,Tuesday,Wednesday,Thursday,Friday -At "13:05"
...
Register-ScheduledTask -TaskName $TaskName -Action $Action -Trigger $Trigger -Settings $Settings -Principal $Principal -Description "BOGA AI Daily Bot - run_all_bots.py weekdays 13:05 UTC" -Force | Out-Null
...
if ($Task) {
    ...
    Write-Host "Schedule: Weekdays 13:05 UTC (09:05 ET)"
