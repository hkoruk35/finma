...
Register-ScheduledTask -TaskName $TaskName -Action $Action -Trigger $Trigger -Settings $Settings -Principal $Principal -Description "BOGA AI Daily Bot - run_all_bots.py (v115.0) weekdays 13:00 NY (EDT)" -Force | Out-Null
