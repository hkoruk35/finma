...
async def main():
    ...
    with open(picks_path, "r", encoding="utf-8") as f: data = json.load(f)

    for p in data['picks']:
        logging.info(f"Analyzing {p['ticker']}...")
    ...
    with open(picks_path, 'w', encoding='utf-8') as f: json.dump(data, f, indent=2, ensure_ascii=False)
    all_path = "frontend/public/swing_all_picks.json"
    if os.path.exists(all_path):
        with open(all_path, 'w', encoding='utf-8') as f: json.dump(data, f, indent=2, ensure_ascii=False)
