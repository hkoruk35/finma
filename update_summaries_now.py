...
def generate_v55_report_local(c: dict) -> dict:
    ...
    langs = {
        "en": {
            ...
            "home": f"BOGA AI assigns {t} a score of {s:.1f}/100. Trend: {tech.get('trend', 'Neutral')}. RSI: {tech.get('rsi_14', 50)}."
        },
        "tr": {
            ...
            "home": f"BOGA AI, {t} için {s:.1f}/100 skor verdi. Trend: {tech.get('trend', 'Nötr')}. RSI: {tech.get('rsi_14', 50)}."
        },
        "es": {
            ...
            "home": f"BOGA AI asigna a {t} una puntuación de {s:.1f}/100. Tendencia: {tech.get('trend', 'Neutral')}. RSI: {tech.get('rsi_14', 50)}."
        },
        "pt": {
            ...
            "home": f"BOGA AI atribui a {t} uma pontuação de {s:.1f}/100. Tendência: {tech.get('trend', 'Neutro')}. RSI: {tech.get('rsi_14', 50)}."
        },
        "fr": {
            ...
            "home": f"BOGA AI attribue à {t} un score de {s:.1f}/100. Tendance: {tech.get('trend', 'Neutre')}. RSI: {tech.get('rsi_14', 50)}."
        },
        "id": {
            ...
            "home": f"BOGA AI memberikan {t} skor {s:.1f}/100. Tren: {tech.get('trend', 'Netral')}. RSI: {tech.get('rsi_14', 50)}."
        }
    }
