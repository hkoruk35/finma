-- Cycle basinda bir kez cekilen piyasa verisini (haftalik OHLC mumlari,
-- degisim%, tahmini giris araligi, trend) 5 dilin taslaklarinda saklamak
-- icin — her post render'inda tekrar API cagirmaya gerek kalmaz, cycle
-- boyunca tutarli kalir.
