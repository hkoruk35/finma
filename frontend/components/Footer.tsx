      ...
      <div className="bg-[#141924] border-b border-[#1e2a3a] px-6 py-5">
        <div className="max-w-5xl mx-auto text-center space-y-2">
          ...
          <p className="text-xs text-[#64748b] leading-relaxed">
            <strong className="text-[#94a3b8]">BOGA AI - Blue One Global Analysis - US Stock Analysis +500 stocks is strictly for informational and educational purposes only.</strong>{" "}
