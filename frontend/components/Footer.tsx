      ...
      <div className="bg-[#141924] border-b border-[#1e2a3a] px-6 py-5">
        <div className="max-w-5xl mx-auto text-center space-y-2">
          ...
          <p className="text-xs text-[#64748b] leading-relaxed">
            <strong className="text-[#94a3b8]">BOGA - Blue One Global Analysis - Daily +500 stocks is strictly for informational and educational purposes only.</strong>{" "}
            ...
            BOGA does not guarantee the accuracy, completeness, or timeliness of any data or analysis provided.
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              <div className="relative w-8 h-8">
                <img src="/finmawave.png" alt="BOGA - Blue One Global Analysis" className="w-full h-full object-contain rounded-lg" />
              </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-1.5">
              <Link href="/about" className="text-xs text-[#64748b] hover:text-white transition-colors">About BOGA</Link>
        ...
        <div className="border-t border-[#1e2a3a] mt-8 pt-4 text-center">
          <p className="text-xs text-[#64748b]">
            &copy; 2026 BOGA - Blue One Global Analysis. Developed by AFK DaSYS.
          </p>
        </div>
      </div>
    </footer>
