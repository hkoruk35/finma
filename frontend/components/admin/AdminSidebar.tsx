...
const NAV = [
  ...
  { href: "/admin/supertrade", label: "🦅 SPX SuperTrade" },
  ...
  { href: "/admin/analiz-yonetimi", label: "📉 Analiz Yönetimi" },
  { href: "/admin/menu-yonetimi", label: "🧭 Menü Yönetimi" },
  { href: "/admin/brokers", label: "🏦 Broker Yönetimi" },
  ...
  { href: "/admin/sss", label: "❓ SSS Yönetimi" },
