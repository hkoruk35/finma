...
export default function AddToCartButton({ pick, compact = false }: AddToCartButtonProps) {
  ...
  const btnBase = compact
    ? "inline-flex items-center gap-1 px-2 py-1 rounded-lg text-[10px] font-black uppercase tracking-wider transition-all duration-200"
    : "inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[11px] font-black uppercase tracking-wider transition-all duration-200";
