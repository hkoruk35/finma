...
const PRESETS = [
  {
    id: "swing_momentum",
    name: "Swing Momentum",
    desc: "Haftalık Teyitli Trend Takibi — Makro-Mikro Harmoni",
    mode: "swing",
    color: "#06f3aa",
    icon: "🎯",
    pills: ["W-Close>W-EMA50", "EMA20>EMA50>EMA200", "EMA8↑ son3bar/EMA8>EMA20", "RSI(14)>53 & Slope>0", "RVOL>1.3"],
  },
  {
    id: "breakout",
    name: "Breakout",
    desc: "Konsolidasyon & Hacimli Direnç Kırılımı — Donchian Breakout",
    mode: "swing",
    color: "#10b981",
    icon: "📈",
    pills: ["Close>20D-High", "RVOL>2.2", "BBW>EMA(BBW,20)", "ADX(14)>23 & +DI>-DI"],
  },
  {
    id: "bb_squeeze",
    name: "BB Squeeze",
    desc: "Daralma & Patlama Öncesi — TTM Squeeze Birikim",
    mode: "swing",
    color: "#f59e0b",
    icon: "🔥",
    pills: ["BB(20,2)⊂KC(20,1.5)", "CMF>+0.05 (Para giriş)", "Tetik: Close>KC-Upper"],
  },
  {
    id: "day_trade",
    name: "Day Trade",
    desc: "Açılış İvmesi & Gün İçi Momentum — Yüksek Hızlı",
    mode: "day",
    color: "#f97316",
    icon: "⚡",
    pills: ["Gap>1.5% OR ΔDaily>3%", "RVOL>3.0", "ATR(14)>2.5%", "SL: -5% (Fixed Floor)"],
  },
  {
    id: "long_term",
    name: "Long Term",
    desc: "Nitelikli Büyüme & Kurumsal Kale — Temeller Sağlam",
    mode: "investment",
    color: "#06b6d4",
    icon: "💰",
    pills: ["RevGrowth(YoY)>20%", "ROE>15%", "Close>SMA200 (10D sabit)", "MCap>$5B"],
  },
];
