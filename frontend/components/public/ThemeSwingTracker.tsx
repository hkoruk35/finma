...
const COLUMN_HEADERS: Record<Locale, { label: string; key: string | null; align: "left" | "right" }[]> = {
  ...
  es: [
    ...
    { label: "EMA50", key: "ema50", align: "right" },
    { label: "EMA200", key: "ema200", align: "right" },
    { label: "ESTADO (Tendencia)", key: null, align: "right" },
    { label: "RSI", key: "rsi", align: "right" },
    { label: "PATRÓN (Diario)", key: null, align: "right" },
    { label: "SEÑAL (Diario)", key: "signal", align: "right" },
  ...
  fr: [
    ...
    { label: "EMA50", key: "ema50", align: "right" },
    { label: "EMA200", key: "ema200", align: "right" },
    { label: "STATUT (Tendance)", key: null, align: "right" },
    { label: "RSI", key: "rsi", align: "right" },
    { label: "MOTIF (Quotidien)", key: null, align: "right" },
    { label: "SIGNAL (Quotidien)", key: "signal", align: "right" },
