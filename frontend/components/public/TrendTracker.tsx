            ...
            <thead>
              <tr style={{ borderBottom: "1px solid #30363d" }}>
                {((locale === "tr" ? [
                  ...
                  { label: "TEMA", key: null, align: "left", mobile: false },
                  ...
                  { label: "TICKER", key: null, align: "left", mobile: true },
                  { label: "THEME", key: null, align: "left", mobile: false },
                  ...
                  return (
                    <Fragment key={`${r.ticker}-${r.themeTitle}`}>
                      <tr onClick={() => setShowPremiumModal(true)} style={{ background: "#0f1117", borderBottom: "1px solid #21262d", cursor: "pointer" }}>
                        ...
                        <td className="hidden sm:table-cell" style={{ padding: "6px 8px", color: "#8b949e", fontSize: 11 }}>{themeLabel(r.themeTitle, locale)}</td>
                        ...
                        <td className="hidden sm:table-cell" style={{ padding: "6px 8px", textAlign: "right", color: emaColor(d?.price?.current ?? r.price, d?.tracker_1h?.ema_20) }}>
                          {fmt2(d?.tracker_1h?.ema_20)} {emaArrow(d?.price?.current ?? r.price, d?.tracker_1h?.ema_20)}
                        </td>
                        <td className="hidden sm:table-cell" style={{ padding: "6px 8px", textAlign: "right", color: emaColor(d?.price?.current ?? r.price, d?.tracker_1h?.ema_50) }}>
                          {fmt2(d?.tracker_1h?.ema_50)} {emaArrow(d?.price?.current ?? r.price, d?.tracker_1h?.ema_50)}
                        </td>
                        <td className="hidden sm:table-cell" style={{ padding: "6px 8px", textAlign: "right", color: emaColor(d?.price?.current ?? r.price, d?.tracker_1h?.ema_200) }}>
