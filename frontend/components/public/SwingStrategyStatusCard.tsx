...
const T: Record<Locale, {
  ...
  tr: {
    ...
    pendingMessage: "Bu hisse BOGA AI'nin aktif Trend (Power Pullback) havuzunda — teknik olarak alınabilir bölgede. Daha yüksek kârlılık için hassas giriş noktasının (15 dakikalık tetik) oluşması bekleniyor.",
    enteredMessage: "Bu hisse BOGA AI'nin aktif Trend (Power Pullback) havuzunda ve hassas giriş noktası (15 dakikalık tetik) yakalandı.",
    inWatchlist: "Bu hisse şu an Watchlist havuzunda izleniyor — henüz Trend adayı değil",
  ...
  en: {
    ...
    pendingMessage: "This stock is in BOGA AI's active Trend (Power Pullback) pool — technically in a buyable zone. A precise entry point (15-minute trigger) is awaited for higher profitability.",
    enteredMessage: "This stock is in BOGA AI's active Trend (Power Pullback) pool and the precise entry point (15-minute trigger) has been captured.",
    inWatchlist: "This stock is currently being tracked in the Watchlist pool — not yet a Trend candidate",
  ...
  es: {
    ...
    pendingMessage: "Esta acción está en el pool activo de Tendencia (Power Pullback) de BOGA AI — técnicamente en una zona comprable. Se espera un punto de entrada preciso (gatillo de 15 minutos) para mayor rentabilidad.",
    enteredMessage: "Esta acción está en el pool activo de Tendencia (Power Pullback) de BOGA AI y se ha capturado el punto de entrada preciso (gatillo de 15 minutos).",
    inWatchlist: "Esta acción está siendo seguida en el pool de Watchlist — aún no es candidata de Tendencia",
  ...
  fr: {
    ...
    pendingMessage: "Cette action est dans le pool Tendance actif (Power Pullback) de BOGA AI — techniquement dans une zone d'achat. Un point d'entrée précis (déclencheur de 15 minutes) est attendu pour une rentabilité plus élevée.",
    enteredMessage: "Cette action est dans le pool Tendance actif (Power Pullback) de BOGA AI et le point d'entrée précis (déclencheur de 15 minutes) a été capturé.",
    inWatchlist: "Cette action est actuellement suivie dans le pool Watchlist — pas encore candidate Tendance",
  ...
  pt: {
    ...
    pendingMessage: "Esta ação está no pool ativo de Tendência (Power Pullback) da BOGA AI — tecnicamente em uma zona de compra. Um ponto de entrada preciso (gatilho de 15 minutos) é aguardado para maior lucratividade.",
    enteredMessage: "Esta ação está no pool ativo de Tendência (Power Pullback) da BOGA AI e o ponto de entrada preciso (gatilho de 15 minutos) foi capturado.",
    inWatchlist: "Esta ação está sendo monitorada no pool de Watchlist — ainda não é candidata a Tendência",
