...
const STATUS_STYLE: Record<TrendStatus, { color: string; tr: string; en: string; pt: string; es: string; fr: string }> = {
...
function statusLabel(status: TrendStatus, locale: Locale) {
