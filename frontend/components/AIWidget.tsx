    ...
    <div className="glass-card border-t-2 border-t-[#3b82f6] overflow-hidden">
      <div className="p-4 bg-gradient-to-r from-[#0d1117] to-[#1a1f2e] border-b border-[#1e2a3a]">
        <div className="flex items-center gap-2 mb-1">
          ...
          <h3 className="text-sm font-medium text-white uppercase tracking-widest">BOGA AI</h3>
          <span className="text-[9px] font-medium text-[#3b82f6] bg-[#3b82f6]/10 px-1.5 py-0.5 rounded">BETA</span>
        </div>
