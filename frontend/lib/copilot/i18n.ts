...
const T: Record<string, Record<CopilotLocale, string>> = {
  ...
  liveAnalysisSummary: {
    tr: "{ticker} şu anda takip listelerimizden birinde değil, bu yüzden senin için hızlıca canlı bir analiz çıkardım. BOGA Güven Skoru: {score}/100.",
  ...
  trendListAnalysisSummary: {
    tr: "Şu anda {ticker}, Trend Listesi'nde takip ediliyor. BOGA Güven Skoru: {score}/100.",
  ...
  trendCandidateAnalysisSummary: {
    tr: "Şu anda {ticker}, Trend Adayı olarak radarımızda — henüz teyit tamamlanmadı. BOGA Güven Skoru: {score}/100.",
  ...
  inListAnalysisSummary: {
    tr: "Şu anda {ticker}, {categoryName} listesinde. BOGA Güven Skoru: {score}/100.",
