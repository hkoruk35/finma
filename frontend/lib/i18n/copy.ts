...
export const copy = {
  ...
  fr: {
    ...
    account: {
      ...
      emailLabel: "Adresse e-mail",
      planLabel: "Plan",
      trialEndsLabel: "Fin de la période d'essai",
      trialMessage: "Vous êtes en période d'essai gratuite de 7 jours.",
    ...
    top100: {
      ...
      swingDailyBadge: "Swing Quotidien",
      colTicker: "Ticker",
  ...
  pt: {
    ...
    account: {
      ...
      emailLabel: "E-mail",
      planLabel: "Plano",
      trialEndsLabel: "Término do teste",
      trialMessage: "Você está em um teste gratuito de 7 dias.",
