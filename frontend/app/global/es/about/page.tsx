    ...
    <div className="min-h-screen flex flex-col bg-[#0d1117]">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 py-16">
        ...
        <div className="text-center mb-20">
          <p className="text-xs font-medium text-[#3b82f6] uppercase tracking-[0.3em] mb-4">Inteligencia del Mercado de Acciones de EE.UU.</p>
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="glass-card p-8 relative overflow-hidden">
              ...
              <h3 className="text-lg font-medium text-white mb-3">Escaneo Diario del Universo</h3>
            ...
            <div className="glass-card p-8 relative overflow-hidden">
              ...
              <h3 className="text-lg font-medium text-white mb-3">Lista de Seguimiento Diaria de +6,000</h3>
              <p className="text-[#00d2ff] text-sm leading-relaxed">
            ...
            <div className="glass-card p-8 relative overflow-hidden">
              ...
              <h3 className="text-lg font-medium text-white mb-3">Candidatos de Mayor Convicción — Puntuados Individualmente</h3>
              <p className="text-[#00d2ff] text-sm leading-relaxed">
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="glass-card p-8">
              ...
              <h3 className="text-xl font-medium text-white mb-4">Motor Técnico Multi-Factor</h3>
              <p className="text-[#00d2ff] text-sm leading-relaxed">
            ...
            <div className="glass-card p-8">
              ...
              <h3 className="text-xl font-medium text-white mb-4">Superposición Fundamental y Sectorial</h3>
              <p className="text-[#00d2ff] text-sm leading-relaxed">
            ...
            <div className="glass-card p-8">
              ...
              <h3 className="text-xl font-medium text-white mb-4">Comentario IA Propietario</h3>
              <p className="text-[#00d2ff] text-sm leading-relaxed">
            ...
            <div className="glass-card p-8">
              ...
              <h3 className="text-xl font-medium text-white mb-4">Cinco Niveles de Puntuación</h3>
              <p className="text-[#00d2ff] text-sm leading-relaxed">
        ...
        <div className="glass-card p-10 text-center mb-12">
          ...
          <h2 className="text-2xl font-medium text-white mb-4">100% Enfocado en los Mercados de Renta Variable de EE.UU.</h2>
        ...
        <div className="glass-card p-10 text-center relative overflow-hidden">
          ...
          <h2 className="text-2xl font-medium text-white mb-4">Nuestra Misión</h2>
