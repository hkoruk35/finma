...
export default async function EsHomePage() {
  ...
  const marketGroups: MarketGroup[] = [
    { key: "indices", label: "Índices de EE. UU.", items: toMarketItems(INDEX_ITEMS, quotes) },
      ...
      <main className="flex-1 max-w-[1600px] mx-auto w-full px-4 py-6">
        ...
        <div className="-mb-2">
          <ListsNavigation
            ...
            trailingAction={
              <Link
                href={`/global/es/themes/${HOT_THEMES_2026[0].slug}`}
              ...
              >
                {THEMES_BANNER_LABELS.es.browseAll}
        ...
        <ThemesBanner locale="es" showBrowseAll={false} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_300px] gap-5 mt-2 items-start">
          ...
          <div className="flex flex-col gap-4">
            <HomePersonalWatchlistCard locale="es" />
            <HomeListCard title="Sectores" accent="#38bdf8" stocks={sectorStocks} locale="es" />
          </div>
        </div>
