...
export const metadata: Metadata = {
  title: "Rendimiento del Motor Swing | BOGA AI",
  description: "Registros detallados de rendimiento del Motor Swing de BOGA AI. Datos históricos de trading transparentes.",
