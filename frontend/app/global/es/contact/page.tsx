    ...
    <div className="min-h-screen flex flex-col bg-[#0a0e17]">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-6 py-12 md:py-16">
        <nav className="flex items-center gap-2 text-[10px] font-medium text-slate-500 uppercase tracking-widest mb-6">
          ...
          <span className="text-white italic">Soporte y Contacto</span>
        </nav>

        <div className="text-center mb-12">
            <h1 className="text-4xl font-black text-white mb-4 tracking-tight">Soporte y Contacto</h1>
            <p className="text-slate-400 text-sm max-w-xl mx-auto leading-relaxed">
               ¿Necesitas ayuda con tu membresía? ¿Preguntas sobre señales? ¿Consulta de asociación? Envíanos un mensaje directamente.
            </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto">
           {status === "success" ? (
             <div className="glass-card p-12 text-center animate-fade-in border border-[#1e2a3a] bg-[#141924]">
                ...
                <h2 className="text-2xl font-medium text-white mb-2">¡Mensaje Enviado!</h2>
                <p className="text-slate-400 mb-8">Hemos recibido tu consulta y te responderemos en un plazo de 24 horas.</p>
                <button
             ...
             <form onSubmit={handleSubmit} className="glass-card p-8 space-y-6 border border-[#1e2a3a] bg-[#141924]">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                   <div>
                      <label className="block text-[10px] font-medium text-[#8b949e] uppercase tracking-widest mb-2">Tu Nombre</label>
                      <input
                        type="text"
                        required
                   ...
                   <div>
                      <label className="block text-[10px] font-medium text-[#8b949e] uppercase tracking-widest mb-2">Correo Electrónico</label>
                      <input
                        type="email"
                        required
                ...
                <div>
                   <label className="block text-[10px] font-medium text-[#8b949e] uppercase tracking-widest mb-2">Asunto</label>
                   <select
                   ...
                   >
                      ...
                      <option value="Account Support">Cuenta y Suscripción</option>
                      <option value="Bug Report">Informe de Error</option>
                ...
                <div>
                   <div className="flex justify-between items-center mb-2">
                      <label className="block text-[10px] font-medium text-[#8b949e] uppercase tracking-widest">Mensaje</label>
                ...
                {status === "error" && <p className="text-xs text-[#ef4444] text-center font-medium">Error al enviar. Por favor, inténtalo de nuevo.</p>}
             </form>
           )}
        </div>
      </main>
