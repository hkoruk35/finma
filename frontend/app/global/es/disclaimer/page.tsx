  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#0d1117]">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 py-16">
        ...
        <h1 className="text-3xl font-semibold text-white mb-8 tracking-tight">Legal y Cumplimiento</h1>

        <div className="glass-card p-8 space-y-12 text-white leading-relaxed">
          <section>
            <h2 className="text-lg font-medium text-white mb-4">1. No Constituye Asesoramiento Financiero</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-4">2. Divulgación de Alto Riesgo</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-4">3. Privacidad de Datos (Cumplimiento CCPA/GDPR)</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-4">4. Divulgación de Publicidad y Neutralidad</h2>
            <p>
