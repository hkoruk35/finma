  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#0d1117]">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 py-16">
        ...
        <h1 className="text-4xl font-black text-white mb-8 tracking-tight">Términos de Servicio</h1>
        ...
        <div className="glass-card p-8 space-y-6 text-white leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">2. Cuentas de Usuario</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">3. Restricciones de Uso</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">4. Modificaciones del Servicio</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">5. Terminación</h2>
            <p>
