...
export const metadata: Metadata = {
  title: "Las 100 Mejores Acciones - BOGA AI",
  description: "Seguimiento en vivo de las 100 principales acciones.",
    ...
    <div className="min-h-screen flex flex-col bg-[#0a0e17]">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-6 py-4 md:py-6">
        ...
        <div className="flex gap-2 mb-4">
          ...
          <Link href="/global/es/top100" className="text-[10px] font-bold px-3 py-1.5 rounded border border-[#3b82f6] bg-[#3b82f6]/10 text-[#3b82f6]">TOP 100</Link>
