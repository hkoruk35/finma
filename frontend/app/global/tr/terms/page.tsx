  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#0d1117]">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 py-16">
        ...
        <h1 className="text-3xl font-semibold text-white mb-8 tracking-tight">Kullanım Şartları</h1>

        <div className="glass-card p-8 space-y-6 text-white leading-relaxed">
          <section>
            <h2 className="text-lg font-medium text-white mb-3">1. Şartların Kabulü</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-3">2. Kullanıcı Hesapları</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-3">3. Kullanım Kısıtlamaları</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-3">4. Servis Değişiklikleri</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-3">5. Fesih</h2>
            <p>
