    ...
    <div className="min-h-screen flex flex-col bg-[#0a0e17]">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-6 py-4 md:py-6">
        ...
        <div className="flex gap-2 mb-4">
          ...
          <Link href="/global/tr/top7" className="text-[10px] font-bold px-3 py-1.5 rounded border border-[#30363d] text-[#8b949e] hover:border-[#3b82f6] hover:text-[#3b82f6] transition-colors">TOP 7</Link>
