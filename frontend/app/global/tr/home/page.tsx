            ...
            <div className="bg-gradient-to-r from-[#1a2030] to-[#1e293b] border border-[#3b82f6]/30 group-hover:border-[#3b82f6]/80 transition-colors rounded-2xl p-6 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-6 overflow-hidden relative">
              ...
              <div className="flex-1 z-10 text-center md:text-left">
                 <div className="flex items-center gap-3 mb-3 justify-center md:justify-start">
                    <h3 className="text-[#3b82f6] font-black uppercase tracking-[0.2em] text-sm md:text-base">KANıTLANMIŞ PERFORMANS</h3>
                 ...
                 <p className="text-white text-xl md:text-2xl font-bold">
                   BOGA AI Swing Motoru: <span className="text-[#10b981]">{swingStats.stats.win_rate}% Kazanç Oranı</span> {swingStats.stats.period_days} Gün
                 </p>
                 <p className="text-white text-sm mt-2">
                   Yalnızca algoritmik kriterlerle oluşturulan {swingStats.stats.total_picks} yüksek inançlı ticareye dayanır.
                 </p>
              </div>
              ...
              <div className="flex justify-center gap-6 z-10">
                ...
                <div className="text-center">
                   ...
                   <div className="text-[10px] text-[#00d2ff] font-bold uppercase tracking-wider mt-1">Toplam Sinyaller</div>
                </div>
              </div>
            </div>
          </Link>
