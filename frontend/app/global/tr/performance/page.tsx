...
export default async function TrPerformancePage() {
  ...
  if (!performanceData) {
    return <div className="min-h-screen bg-[#000036] text-white p-8 flex items-center justify-center font-bold text-xl uppercase animate-pulse">Performans Verileri Yükleniyor...</div>;
  }
