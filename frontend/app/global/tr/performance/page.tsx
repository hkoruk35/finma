...
export const metadata: Metadata = {
  title: "Sistem Performansı | BOGA AI",
  description: "BOGA AI Swing Engine performans panosu detaylı ticaret kayıtları ve en iyi 100 hisse.",
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#0a0e17]">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 py-8">
        ...
        <div className="mt-12">
          <div className="mb-6">
            <h2 className="text-2xl font-black text-white uppercase tracking-tight mb-2">Hacme Göre En İyi 100 Hisse</h2>
            <p className="text-sm text-slate-400">En aktif işlem gören hisselerin gerçek zamanlı takibi</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-3">
            {top100Tickers.map((stock) => (
              <Link
                key={stock.ticker}
                href={`/global/tr/stock/${stock.ticker}`}
