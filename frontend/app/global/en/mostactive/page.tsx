...
export const metadata: Metadata = {
  title: "BOGASTOCK | Most Active Stocks",
  description: "The highest-volume stocks in the Top 100 today.",
  alternates: { canonical: "https://bogastock.com/global/en/mostactive" },
};
