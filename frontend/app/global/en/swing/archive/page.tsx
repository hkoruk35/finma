...
export const metadata: Metadata = {
  title: "BOGASTOCK | Historical Interactive Technical Chart Analysis",
  description: "Historical archive of interactive technical chart analysis and market data.",
  alternates: { canonical: "https://bogastock.com/global/en/swing/archive" },
};
...
export default async function EnSwingArchivePage() {
    ...
    <div className="min-h-screen flex flex-col bg-[#0a0e17]">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-6 py-4 md:py-6">
        <nav className="flex items-center gap-2 text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-3">
          ...
          <Link href="/global/en/swing" className="hover:text-[#3b82f6] transition-colors">Daily Trending Stock Candidates</Link>
          <span className="opacity-30">/</span>
          <span className="text-white italic">Archive</span>
        </nav>

        <div className="relative z-10">
          <SwingArchiveTracker archives={archives} locale="en" />
        </div>
      </main>
