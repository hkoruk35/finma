...
export const metadata: Metadata = {
  title: "Watchlist",
  alternates: { canonical: "https://bogastock.com/global/id/watchlist", languages: {
...
export default function IDWatchlistPage() {
  return (
    <div className="min-h-screen flex flex-col bg-[#0a0e17]">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-6 py-4 md:py-6">
        ...
        <ListsNavigation locale="id" activePath="watchlist" />

        <div className="relative z-10">
          <WatchlistTracker locale="id" />
        </div>
      </main>
