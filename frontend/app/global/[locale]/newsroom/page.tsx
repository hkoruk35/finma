...
export async function generateMetadata({ params }: Props) {
  ...
  const languages: Record<string, string> = { "x-default": "https://bogastock.com/global/en/newsroom" };
  for (const l of INDEX_LOCALES) languages[l] = `https://bogastock.com/global/${l}/newsroom`;
  return {
    alternates: { canonical: `https://bogastock.com/global/${locale}/newsroom`, languages },
  };
}
