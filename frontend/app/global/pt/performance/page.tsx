...
export const metadata: Metadata = {
  title: "Desempenho do Motor Swing | BOGA AI",
  description: "Registros detalhados de desempenho do Motor Swing da BOGA AI. Dados históricos de negociação transparentes.",
