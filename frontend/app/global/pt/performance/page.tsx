...
export const metadata: Metadata = {
  title: "Desempenho do Motor de Ações em Tendência | BOGA AI",
  description: "Registros detalhados de desempenho do Motor de Ações em Tendência da BOGA AI. Dados históricos de negociação transparentes.",
    ...
    <div className="min-h-screen flex flex-col bg-[#0d1117]">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-6 py-4 md:py-6">
        ...
        <div className="relative z-10">
          <SwingPerformanceDashboard initialHistory={history} stats={performanceData.stats} todayPicks={todayPicks} picksGeneratedAt={picksGeneratedAt} locale="pt" disableTickerLink hideBotLink hideExportButtons applySlPct={-7} />
        </div>
      </main>
