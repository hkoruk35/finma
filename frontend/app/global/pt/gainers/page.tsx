...
export const metadata: Metadata = {
  title: "BOGASTOCK | Maiores Altas",
  description: "As maiores altas do Top 100 hoje.",
  alternates: { canonical: "https://bogastock.com/global/pt/gainers" },
};

export default function PtGainersPage() {
  return (
    <div className="min-h-screen flex flex-col bg-[#0a0e17]">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-6 py-4 md:py-6">
        <nav className="flex items-center gap-2 text-[10px] font-medium text-slate-500 uppercase tracking-widest mb-3">
          ...
          <span className="text-white italic">Maiores Altas</span>
        </nav>

        <ListsNavigation locale="pt" activePath="gainers" />

        <div className="relative z-10">
          <MoverPageTracker mode="gainers" locale="pt" />
        </div>
      </main>
