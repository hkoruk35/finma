...
export const metadata: Metadata = {
  title: "About",
  alternates: { canonical: "https://bogastock.com/global/pt/about", languages: {
...
export default async function AboutPage() {
  const config = await getAboutConfig("pt");
    ...
    <div className="min-h-screen flex flex-col bg-[#0d1117]">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 py-16">
        ...
        <div className="glass-card p-10 text-center relative overflow-hidden">
          ...
          <Link href="/global/pt/future" className="text-[#3b82f6] hover:underline font-medium">Conheça-nos Mais &rarr;</Link>
        </div>
</div>
      </main>
