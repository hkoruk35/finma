...
export const metadata: Metadata = {
  ...
  title: "Sobre a BOGA AI - Blue One Global Analysis - Daily 6,000+ | Análise do Mercado de Ações dos EUA com IA",
  description: "BOGA AI - Blue One Global Analysis - Daily 6,000+ analisa diariamente mais de 6.000 ações e ETFs de destaque dos EUA, identifica os melhores candidatos e entrega análise financeira diária com IA sobre as oportunidades de maior convicção no mercado americano.",
  alternates: {
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 py-16">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-white max-w-2xl mx-auto leading-relaxed">
            BOGA AI - Blue One Global Analysis - Daily 6,000+ é um sistema proprietário de seleção e pontuação de ações em múltiplas etapas que transforma todo o universo de ações americanas em uma lista reduzida de oportunidades de alta probabilidade — todos os dias de negociação.
          </p>
        </div>

        {/* 3-Stage Process */}
        <div className="mb-20">
          <h2 className="text-2xl font-black text-white text-center mb-12 uppercase tracking-widest">Como Funciona o Sistema BOGA AI</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="glass-card p-8 relative overflow-hidden">
              ...
              <p className="text-[#00d2ff] text-sm leading-relaxed">
                Todos os dias, o algoritmo da BOGA AI percorre <strong className="text-white">mais de 6.000 ações e ETFs de destaque dos EUA</strong> em todas as principais bolsas — NYSE, NASDAQ e AMEX — aplicando filtros de liquidez, volatilidade e estrutura para isolar os candidatos mais negociáveis.
              </p>
            </div>
            ...
            <div className="glass-card p-8 relative overflow-hidden">
              ...
              <p className="text-[#00d2ff] text-sm leading-relaxed">
                O motor de pontuação da BOGA AI classifica cada candidato diário e seleciona as configurações de maior convicção. Cada uma recebe uma análise única gerada por IA que cobre técnicos, fundamentos e a justificativa da pontuação — não um modelo genérico, mas um relatório específico para cada ação.
              </p>
            </div>
          </div>
        </div>
        ...
        {/* Scoring System */}
        <div className="mb-20">
          <h2 className="text-2xl font-black text-white text-center mb-12 uppercase tracking-widest">O Sistema de Pontuação BOGA AI</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="glass-card p-8">
              ...
              <p className="text-[#00d2ff] text-sm leading-relaxed">
                A Pontuação Mestra da BOGA AI é calculada a partir de uma combinação ponderada de indicadores técnicos — RSI, MACD, volume relativo, cruzamentos múltiplos de EMA, força de tendência ADX e intensidade de compressão das Bandas de Bollinger — projetada especificamente para estruturas de momentum na renda variável dos EUA.
              </p>
            </div>
            ...
            <div className="glass-card p-8">
              ...
              <p className="text-[#00d2ff] text-sm leading-relaxed">
                Cada ação pré-selecionada recebe um relatório de análise em linguagem simples gerado pelo motor BOGA AI. O relatório explica <em>por que</em> uma pontuação específica foi atribuída — referenciando os próprios dados da ação, não genéricos — para que você entenda a justificativa por trás de cada avaliação.
              </p>
            </div>
            ...
            <div className="glass-card p-8">
              ...
              <p className="text-[#00d2ff] text-sm leading-relaxed">
                As pontuações da BOGA AI são classificadas em cinco níveis profissionais: <strong className="text-white">Alta Convicção</strong>, <strong className="text-white">Viés Positivo</strong>, <strong className="text-white">Neutro</strong>, <strong className="text-white">Viés Negativo</strong> e <strong className="text-white">Baixo Desempenho</strong> — proporcionando clareza de nível institucional sem ambiguidade.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="glass-card p-10 text-center mb-12">
          ...
          <p className="text-white max-w-2xl mx-auto leading-relaxed mb-6">
            BOGA AI - Blue One Global Analysis - Daily 6,000+ é projetado especificamente para o mercado de ações dos EUA. Cada algoritmo, cada peso e cada categoria de pontuação é calibrado em relação à NYSE, NASDAQ e à estrutura do mercado americano — não é um modelo global genérico adaptado para os EUA.
          </p>
