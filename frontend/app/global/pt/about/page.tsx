...
export const metadata: Metadata = {
  ...
  description: "BOGASTOCK - Blue One Global Analysis - Daily 6,000+ analisa diariamente mais de 6.000 ações e ETFs de destaque dos EUA, identifica os melhores candidatos e entrega interactive charts diária com IA sobre as oportunidades de maior convicção no mercado americano.",
  alternates: {
    ...
    <div className="min-h-screen flex flex-col bg-[#0d1117]">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 py-16">
        ...
        <div className="text-center mb-20">
          <p className="text-xs font-medium text-[#3b82f6] uppercase tracking-[0.3em] mb-4">Inteligência do Mercado de Ações dos EUA</p>
          <h1 className="text-4xl md:text-6xl font-black text-white mb-6 tracking-tight leading-tight">
            Interactive Charts Diária.<br />
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="glass-card p-8 relative overflow-hidden">
              ...
              <h3 className="text-lg font-medium text-white mb-3">Varredura Diária do Universo</h3>
            ...
            <div className="glass-card p-8 relative overflow-hidden">
              ...
              <h3 className="text-lg font-medium text-white mb-3">Lista de Acompanhamento Diária de +6.000</h3>
              <p className="text-[#00d2ff] text-sm leading-relaxed">
            ...
            <div className="glass-card p-8 relative overflow-hidden">
              ...
              <h3 className="text-lg font-medium text-white mb-3">Candidatos de Maior Convicção — Pontuados Individualmente</h3>
              <p className="text-[#00d2ff] text-sm leading-relaxed">
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="glass-card p-8">
              ...
              <h3 className="text-xl font-medium text-white mb-4">Motor Técnico Multi-Fator</h3>
              <p className="text-[#00d2ff] text-sm leading-relaxed">
            ...
            <div className="glass-card p-8">
              ...
              <h3 className="text-xl font-medium text-white mb-4">Sobreposição Fundamental e Setorial</h3>
              <p className="text-[#00d2ff] text-sm leading-relaxed">
            ...
            <div className="glass-card p-8">
              ...
              <h3 className="text-xl font-medium text-white mb-4">Comentário de IA Proprietário</h3>
              <p className="text-[#00d2ff] text-sm leading-relaxed">
            ...
            <div className="glass-card p-8">
              ...
              <h3 className="text-xl font-medium text-white mb-4">Cinco Níveis de Pontuação</h3>
              <p className="text-[#00d2ff] text-sm leading-relaxed">
        ...
        <div className="glass-card p-10 text-center mb-12">
          ...
          <h2 className="text-2xl font-medium text-white mb-4">100% Focado nos Mercados de Ações dos EUA</h2>
        ...
        <div className="glass-card p-10 text-center relative overflow-hidden">
          ...
          <h2 className="text-2xl font-medium text-white mb-4">Nossa Missão</h2>
