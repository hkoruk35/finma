  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#0d1117]">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 py-16">
        ...
        <h1 className="text-3xl font-semibold text-white mb-8 tracking-tight">Política de Privacidade</h1>

        <div className="glass-card p-8 space-y-6 text-white leading-relaxed">
          <p>Última atualização: Abril de 2026</p>

          <section>
            <h2 className="text-lg font-medium text-white mb-3">1. Informações que Coletamos</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-3">2. Como Usamos os Dados</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-3">3. Compartilhamento de Dados</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-3">4. Segurança</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-3">5. Seus Direitos</h2>
            <p>
