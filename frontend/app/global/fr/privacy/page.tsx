  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#0d1117]">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 py-16">
        ...
        <h1 className="text-4xl font-black text-white mb-8 tracking-tight">Politique de Confidentialité</h1>
        ...
        <div className="glass-card p-8 space-y-6 text-white leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">2. Comment nous Utilisons les Données</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">4. Sécurité</h2>
            <p>
