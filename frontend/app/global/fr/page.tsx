...
export const metadata: Metadata = {
  ...
  description: "Analyse d'actions en temps réel alimentée par l'IA. Candidats Swing Trade avec signaux EMA/RSI. Mises à jour horaires.",
  alternates: { canonical: "https://bogastock.com/global/fr" },
};

export default async function FrLandingPage() {
  const cfg = await getLandingConfigFromDB("fr");
  if (!cfg) return null;
      ...
      <main className="flex-1">
        ...
        <section className="max-w-5xl mx-auto px-4 pt-20 pb-16 text-center">
          ...
          <p className="text-lg md:text-xl text-white/50 max-w-2xl mx-auto leading-relaxed mb-4">
            <span className="text-white/80 font-semibold">{hero.description_bold}</span> â€” {hero.description}
          </p>
        ...
        <section className="max-w-5xl mx-auto px-4 pb-16">
          <ScreenshotBanner lang="fr" />
        </section>

        {/* Features */}
        {features.length > 0 && (
          <section className="max-w-5xl mx-auto px-4 pb-20">
            <h2 className="text-2xl font-black text-white tracking-tighter text-center mb-10">Ce que vous obtenez avec BOGASTOCK</h2>
        ...
        {/* Pricing */}
        <PricingSection locale="fr" ctaHref={cta_primary.href} />
      </main>
