  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#0d1117]">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 py-16">
        ...
        <h1 className="text-3xl font-semibold text-white mb-8 tracking-tight">Conditions d'Utilisation</h1>

        <div className="glass-card p-8 space-y-6 text-white leading-relaxed">
          <section>
            <h2 className="text-lg font-medium text-white mb-3">1. Acceptation des Conditions</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-3">2. Comptes Utilisateur</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-3">3. Restrictions d'Utilisation</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-3">4. Modifications du Service</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-3">5. Résiliation</h2>
            <p>
