...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes = [
    ...
    { route: '/global/es/trend',             priority: 0.85, cf: 'daily'  },
    { route: '/global/es/performance',       priority: 0.8, cf: 'daily'   },
    { route: '/global/es/top100',            priority: 0.85, cf: 'daily'  },
    ...
    { route: '/global/fr/trend',             priority: 0.85, cf: 'daily'  },
    { route: '/global/fr/performance',       priority: 0.8, cf: 'daily'   },
    { route: '/global/fr/top100',            priority: 0.85, cf: 'daily'  },
    ...
    { route: '/global/pt/trend',             priority: 0.85, cf: 'daily'  },
    { route: '/global/pt/performance',       priority: 0.8, cf: 'daily'   },
    { route: '/global/pt/top100',            priority: 0.85, cf: 'daily'  },
