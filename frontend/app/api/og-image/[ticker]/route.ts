    ...
    >
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "30px" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
          <div style={{ fontSize: "32px", fontWeight: "700", color: "#00d2ff" }}>BOGA AI</div>
          <div style={{ fontSize: "18px", color: "#94a3b8" }}>Stock Analysis</div>
        </div>
        <div style={{ fontSize: "36px", fontWeight: "800", color: "#00d2ff" }}>{tickerUpper}</div>
      </div>
      ...
      >
        <div style={{ width: "20px", height: "40px", background: "#10b981" }} />
        <div style={{ width: "20px", height: "50px", background: "#ef4444" }} />
        <div style={{ width: "20px", height: "35px", background: "#10b981" }} />
        <div style={{ width: "20px", height: "60px", background: "#10b981" }} />
        <div style={{ width: "20px", height: "45px", background: "#ef4444" }} />
        <div style={{ width: "20px", height: "55px", background: "#10b981" }} />
      </div>
