          ...
          <>
            ...
            <div className="glass-card p-5 grid grid-cols-1 md:grid-cols-3 gap-6 text-[11px] text-[#00d2ff] border border-white/5">
              ...
              <div className="flex flex-col gap-1 md:text-right">
                ...
                <Link href="/daytrade-performance" className="text-[#10b981] hover:underline font-black">VIEW DAYTRADE PERFORMANCE HISTORY →</Link>
                <Link href="/swing" className="text-[#3b82f6] hover:underline mt-1 font-bold">Switch to Swing Terminal</Link>
              </div>
            </div>
          </>
        )}
