    ...
    <div className="min-h-screen flex flex-col bg-[#0d1117]">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 py-16">
        <div className="text-center mb-12">
            ...
            <p className="text-[#94a3b8] text-lg font-medium">Questions about signals? Partnership inquiry? We're here to help.</p>
        </div>
            ...
            <div className="md:col-span-2">
               {status === "success" ? (
                 <div className="glass-card p-12 text-center animate-fade-in">
                    ...
                    <p className="text-[#94a3b8] mb-8">We've received your inquiry and will get back to you within 24 hours.</p>
                    <button 
                 ...
                 <form onSubmit={handleSubmit} className="glass-card p-8 space-y-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                       <div>
                          <label className="block text-xs font-bold text-[#94a3b8] uppercase tracking-widest mb-2">Your Name</label>
                          <input 
                            type="text" 
                            required 
                       ...
                       <div>
                          <label className="block text-xs font-bold text-[#94a3b8] uppercase tracking-widest mb-2">Email Address</label>
                          <input 
                            type="email" 
                            required 
                    ...
                    <div>
                       <label className="block text-xs font-bold text-[#94a3b8] uppercase tracking-widest mb-2">Subject</label>
                       <select 
                    ...
                    <div>
                       <div className="flex justify-between items-center mb-2">
                          <label className="block text-xs font-bold text-[#94a3b8] uppercase tracking-widest">Message</label>
                          <span className={`text-[10px] font-mono ${formState.message.length > 900 ? 'text-[#ef4444]' : 'text-[#64748b]'}`}>
