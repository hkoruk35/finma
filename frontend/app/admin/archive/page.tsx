      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-16">
           {dates.map((date) => (
              ...
              >
                 <div>
                    <p className="text-[10px] font-medium text-[#00d2ff] uppercase tracking-[0.2em] mb-1">Trading Session</p>
        ...
        <div className="glass-card p-8 bg-gradient-to-br from-[#141924] to-[#0a0e17] relative overflow-hidden">
          ...
          <div className="max-w-2xl">
            <h3 className="text-xl font-medium text-white mb-3">About the Archive</h3>
            <p className="text-sm text-white leading-relaxed mb-6">
              The BOGA AI archive stores full snapshots of the daily 6,000+ stock universe. Unlike the live dashboard which updates every trading morning at 09:00 NY time, these pages preserve the exact signals and AI summaries generated on that specific date.
            </p>
            <div className="flex items-center gap-6 text-[10px] font-medium text-[#00d2ff] uppercase tracking-widest">
