    ...
    <div className="animate-fade-in">
      <div className="mb-8 flex items-center justify-between">
         <div>
            ...
            <p className="text-sm text-[#00d2ff]">Configure banner placements and direct advertising scripts.</p>
         </div>
      ...
      <div className="space-y-6">
         {[
            ...
            <div key={ad.id} className="glass-card p-6 flex flex-col md:flex-row md:items-center gap-6">
               <div className="w-full md:w-32 h-20 bg-[#141924] border border-[#1e2a3a] flex items-center justify-center text-[10px] text-[#00d2ff]">
                  {ad.size} Preview
               </div>
               
               <div className="flex-1 grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div>
                     <p className="text-[10px] text-[#00d2ff] uppercase tracking-widest mb-1">ID / Position</p>
                     <p className="text-sm font-bold text-white">{ad.id}</p>
                     <p className="text-[10px] text-white">{ad.pos}</p>
                  </div>
                  <div>
                     <p className="text-[10px] text-[#00d2ff] uppercase tracking-widest mb-1">Status</p>
                  ...
                  <div>
                     <p className="text-[10px] text-[#00d2ff] uppercase tracking-widest mb-1">Today's Est.</p>
                     <p className="text-sm font-mono font-bold text-white">{ad.revenue}</p>
                  </div>
                  <div className="flex items-center justify-end gap-3">
                     <button className="p-2 text-[#00d2ff] hover:text-[#3b82f6] transition-colors">
                        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                        </svg>
                     </button>
                     <button className="p-2 text-[#00d2ff] hover:text-[#ef4444] transition-colors">
                        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="mt-8 glass-card p-6">
         ...
         <textarea 
            rows={5}
            className="w-full bg-[#141924] border border-[#1e2a3a] rounded-xl px-4 py-3 font-mono text-xs text-white focus:outline-none focus:border-[#3b82f6]"
