  ...
  return (
    <div className="animate-fade-in">
      <div className="mb-8">
         ...
         <p className="text-sm text-[#00d2ff]">Configure global parameters, security, and API integrations.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
         ...
         <div className="glass-card p-6">
            ...
            <div className="space-y-6">
               <div className="grid grid-cols-2 gap-4">
                  <div>
                     <label className="block text-[10px] font-bold text-[#00d2ff] uppercase tracking-widest mb-2">Site Title</label>
                     <input type="text" defaultValue="BOGA AI Daily +500" className="w-full bg-[#141924] border border-[#1e2a3a] rounded-xl px-4 py-3 text-sm" />
                  </div>
                  <div>
                     <label className="block text-[10px] font-bold text-[#00d2ff] uppercase tracking-widest mb-2">Admin Email</label>
               ...
               <div>
                  <label className="block text-[10px] font-bold text-[#00d2ff] uppercase tracking-widest mb-2">Maintenance Mode</label>
                  <div className="flex items-center gap-4 bg-[#141924] p-4 rounded-xl border border-[#1e2a3a]">
                     ...
                     <span className="text-xs text-white">Redirect all traffic to maintenance landing page.</span>
                  </div>
               </div>
         ...
         <div className="glass-card p-6">
            ...
            <div className="space-y-6">
               <div>
                  <label className="block text-[10px] font-bold text-[#00d2ff] uppercase tracking-widest mb-1">Gemini AI Model</label>
               ...
               <div className="relative">
                  <label className="block text-[10px] font-bold text-[#00d2ff] uppercase tracking-widest mb-1">JWT Secret Key</label>
