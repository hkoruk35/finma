    ...
    <div className="min-h-screen bg-[#0a0e17] p-2 md:p-3 text-slate-300">
      <header className="mb-3 flex flex-col md:flex-row md:items-end justify-between gap-2 border-b border-[#1c2635] pb-2">
        ...
        <Link
          ...
          className="flex items-center gap-1.5 rounded bg-[#3b82f6]/10 hover:bg-[#3b82f6]/20 border border-[#3b82f6]/30 transition-colors px-2 py-1 text-[11px] font-medium text-[#3b82f6] whitespace-nowrap"
        >
          ⚡ SPYEngine'e
        </Link>
      </header>
