...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://bogastock.com/tr" },
};
        ...
        <section className="max-w-5xl mx-auto px-4 pb-16">
          <div className="rounded-2xl border border-[#1e2a3a] overflow-hidden shadow-2xl shadow-black/50">
                  ...
                  {SAMPLE_ROWS.map((r) => (
                    <tr key={r.ticker} className={`border-t border-[#1e2a3a] ${r.swing ? "bg-blue-500/[0.05]" : "bg-[#0a0e17]"}`}>
                      <td className="px-4 py-3">
                        ...
                        {r.swing && (
                          <span className="ml-2 text-[8px] bg-blue-500/20 text-blue-300 px-1.5 py-0.5 rounded-full font-medium align-middle">Günlük Swing</span>
                        )}
                      </td>
                      ...
                      <td className="px-4 py-3 text-center">
                        <span className={`inline-block px-2 py-0.5 rounded text-[10px] font-medium border ${SIGNAL_STYLE[r.sigKey]}`}>{r.signal}</span>
                      </td>
                    </tr>
                  ))}
                </tbody>
            ...
            <div className="bg-[#0d1117] border-t border-[#1e2a3a] px-4 py-3 text-center">
              <Link href="/tr/kayit" className="text-[#3b82f6] text-xs font-medium hover:underline">
