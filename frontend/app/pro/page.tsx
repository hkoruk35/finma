      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 py-6">
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-1 gap-6">
            ...
            <Link href="/csp/active" className="group border border-green-900/40 rounded-lg p-6 hover:border-green-500/60 hover:bg-green-950/10 transition-all duration-200">
